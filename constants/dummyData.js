...
const messages = [
  {
    id: '1',
    userName: 'Jia Zahid',
    userImg: require('../assets/dummyData/profile-(1).jpg'),
    messageTime: '4 mins ago',
    messageText: 'How Much?',
  },
  {
    id: '2',
    userName: 'Hassan Furqan',
    userImg: require('../assets/dummyData/profile-(2).jpg'),
    messageTime: '2 hours ago',
    messageText: 'Final Price Bro?',
  },
  {
    id: '3',
    userName: 'Rukhsar Khalid',
    userImg: require('../assets/dummyData/profile-(3).jpg'),
  ...
  },
  {
    id: '4',
    userName: 'Touqeer',
    userImg: require('../assets/dummyData/profile-(5).jpg'),
    messageTime: '1 day ago',
    messageText: 'Stay Blessed',
  },
  {
    id: '5',
    userName: 'Hamza Nazir',
    userImg: require('../assets/dummyData/profile-(4).jpg'),
    messageTime: '2 days ago',
    messageText: 'Is it available or not?',
  },
];
...
const myCards = [
  {
    id: 1,
    name: 'EasyPaisa',
    icon: require('../assets/icons/easypaisa.png'),
    card_no: '1234',
  },
  {
    id: 2,
    name: 'JazzCash',
    icon: require('../assets/icons/jazzcash.png'),
    card_no: '1234',
  },
];
